...
int main(void)
{
    ...
    //final digit
    j = number % 10;
    printf("next is %lld ", number);
    printf("digit is %d Final\n", j);
    remainders += j;
    ...
    printf("next is %lld ", secondlastdigit);
    printf("digit is %d Second\n", k);
    ...
    while (getremainders != 0)
    {
        ...
        i = getremainders % 10;
        remainders += i;
        printf("next is %lld ", getremainders);
        printf("digit is %d loop two\n", i);
    }
    number /= 10;
    while (getdigits != 0)
    {
        ...
        printf("next is %lld ", getdigits);
        printf("digit is %d loop three\n", i);
    }
    printf("Digits add to: %d\n", digits);
    printf("Remainders add to: %d\n", remainders);
    check = digits + remainders;
    printf("Validation: %lld\n", check);
